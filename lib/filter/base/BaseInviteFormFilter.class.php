...
class BaseInviteFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'invited_customer_id'  => new sfWidgetFormFilterInput(),
      'bonus_transaction_id' => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'invited_customer_id'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'bonus_transaction_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ));
