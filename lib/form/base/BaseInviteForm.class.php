...
class BaseInviteForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'invited_customer_id'  => new sfWidgetFormInput(),
      'bonus_transaction_id' => new sfWidgetFormInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'invited_customer_id'  => new sfValidatorInteger(array('required' => false)),
      'bonus_transaction_id' => new sfValidatorInteger(array('required' => false)),
    ));
