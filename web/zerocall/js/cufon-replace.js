...
Cufon.replace('.login-left label', { fontFamily: 'Calibri' });
...
Cufon.set('fontSize', '13px').replace('.col label.error', { fontFamily: 'Calibri' });
...
Cufon.set('fontSize', '16px').replace('.termsnconditions  ul li span.termhead', { fontFamily: 'Calibri'});
