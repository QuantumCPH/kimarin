...
<table width="600px">
    <tr style="border:0px solid #fff">
        <td colspan="4" align="right" style="text-align:right; border:0px solid #fff"><?php echo image_tag(sfConfig::get('app_web_url').'images/logo.jpg', array("width"=>'170px')); ?></td>
    </tr>
</table>
<table class="receipt" cellspacing="0" width="600px">
    <tr bgcolor="#CCCCCC" class="receipt_header">
        <th colspan="2"><?php echo __('Order Receipt') ?></th>
        <th><?php echo __('Receipt No.') ?> <?php echo $transaction->getReceiptNo(); ?></th>
    </tr>
    <tr> 
    ...
    <tr class="footer">
        ...
        <td align="right" style="padding-right: 65px;"><?php echo number_format($transaction->getAmount() - $transaction->getExtraRefill(), 2) ?><?php echo sfConfig::get('app_currency_code');?></td>
    </tr>
    <tr class="footer">
        <td>&nbsp;</td>
