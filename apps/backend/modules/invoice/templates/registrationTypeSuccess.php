...
<table width="75%" cellspacing="0" cellpadding="2" class="tblAlign">
 ...
 <?php
 $csv_hdr="";
 $csv_hdr = "ID,Modules,Day 1,Day 2,Day 3,Day 4,Day 5,Day 6,Day 7,Day 8,Day 9,Day 10,Day 11,Day 12,Day 13,Day 14,Day 15,Day 16,Day 17,Day 18,Day 19,Day 20,Day 21,Day 22,Day 23,Day 24,Day 25,Day 26,Day 27,Day 28,Day 29,Day 30,Day 31,Total";    ?>   
    <th>ID</th>
    <th>Modules</th>
    <th>Day 1</th>
    <th>Day 2</th>
...
?>
   ...
   <td><?php  echo $rowObj->id;   $csv_output .= $rowObj->id. ", ";   ?></td>
    <td><?php  echo $rowObj->description;    $csv_output .= $rowObj->description. ", ";   ?></td>
...
$i++;
          ...
          <tr>
              <td  colspan="2"> <?php $csv_output .="Total ".", ,"; echo "Total";   ?></td>
