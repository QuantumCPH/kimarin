...
<div id="sf_admin_container"><h1>Charge Detail</h1></div>
...
<form id="sf_admin_form" name="sf_admin_edit_form" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="company_id" value="<?php echo $company->getId()?>" />
            ...
            <tr>
                <td style="padding: 5px;">Charge Amount:</td>
                <td style="padding: 5px;">
                    
                    <input type="hidden" name="chargeAmt" value="<?php echo $chargeAmt?>" />                    
                    <?php echo number_format($chargeAmt, 2);?><b><?php echo sfConfig::get('app_currency_code');?></b>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 5px;">
                    ...
                    <input type="hidden" name="totalPayment" value="<?php echo $chargeAmt+$vat?>" />                    
                    <?php echo number_format($chargeAmt+$vat,2);?><b><?php echo sfConfig::get('app_currency_code');?></b>
                </td>
            </tr>
        ...
        <div id="sf_admin_container">
            <ul class="sf_admin_actions">
                <li><input type="submit" name="chargesave" value="Charge" class="sf_admin_action_save" /></li>
            </ul>
        </div>
    </div>
</form>
