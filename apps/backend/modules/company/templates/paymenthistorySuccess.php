...
<tr  <?php echo $class;?>>
    ...
    <td><a href="<?php echo sfConfig::get('app_admin_url'). "company/ShowReceipt?tid=".$transaction->getId()?>" target="_blank"> <img src="<?php echo sfConfig::get('app_web_url')?>/sf/sf_admin/images/default_icon.png" title=<?php echo __("view")?> alt=<?php echo __("view")?> /></a></td>
</tr>
<?php endforeach; ?>
