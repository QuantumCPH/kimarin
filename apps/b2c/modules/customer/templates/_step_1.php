    ...
    <div class="split-form-sign-up">
        ...
        <ul>
          ...
          <li><?php  $error_terms_conditions = false;;
            ...
            </span><?php } ?><?php echo $form['terms_conditions'] ?><span><a href="../customer/termsAndCondition" target="_parent" style="outline:none"><?php echo $form['terms_conditions']->renderHelp() ?></a></span>             
          </li>
          <li>
             <?php
