          ...
          <ul>   
            ...
            <li>
             ...
             <div class='inline-error'><?php echo $error_mobile_number?$form['mobile_number']->renderError():'&nbsp;'?>
                ...
                <label style="float:right;width:85px;font-weight:normal;<?php if ($error_mobile_number): ?> margin-right:85px; <?php else: ?>margin-right: 7px;<?php endif; ?>">ex. 0701234567</label>
            </li>
            <!-- end mobile_number -->  
            <?php 
